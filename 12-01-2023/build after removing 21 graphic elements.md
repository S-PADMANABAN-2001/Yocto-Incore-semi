...
Fetching: 100% (5/5), done in 52.066s
Checking out: 100% (5/5), done in 0.528s
...
Fetching: 100% (5/5), done in 3.244s
Checking out: 100% (5/5), done in 0.531s
repo sync has finished successfully.
...
Parsing of 2524 .bb files complete (0 cached, 2524 parsed). 3971 targets, 436 skipped, 0 masked, 0 errors.
...
<font color="#A2734C"><b>WARNING</b></font>: <font color="#A2734C">curl-native-7.85.0-r0 do_fetch: Failed to fetch URL https://curl.se/download/curl-7.85.0.tar.xz, attempting MIRRORS if available</font>
